...
namespace WorkingSpaces.Controllers.Api
{
    ...
    public class AccountApiV1Controller : ControllerBase
    {
        private readonly ApplicationDbContext _context;
        private readonly IConfiguration _config;

        public AccountApiV1Controller(ApplicationDbContext context, IConfiguration config)
        {
            _context = context;
            _config = config;
        }
    ...
    [ApiVersion("2.0")]
    [Route("api/v{version:apiVersion}/accountapi")]
    public class AccountApiV2Controller : ControllerBase
    {
        private readonly ApplicationDbContext _context;
        private readonly IConfiguration _config;

        public AccountApiV2Controller(ApplicationDbContext context, IConfiguration config)
        {
            _context = context;
            _config = config;
        }
        ...
        private TimeZoneInfo GetKyivTimeZone()
        {
            ...
            catch { return TimeZoneInfo.FindSystemTimeZoneById("E. Europe Standard Time"); }
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            return Ok(new { token, message = "Login successful (v2)" });
        }
